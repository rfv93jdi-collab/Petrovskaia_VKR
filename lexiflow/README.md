...
Веб‑приложение для аудита юридических документов: извлечение ключевых фрагментов (пункты/сущности) и генерация описания рисков с рекомендациями. Фронтенд и бэкенд (TypeScript) живут в одном проекте; API для анализа реализован в `server.ts`.
